    ...
    this.authService.loginUser(value)
      .then(res => {
        ...
        if (err.message === 'The email address is badly formatted.') {
          this.errorMessage = 'El formato de la dirección de correo electrónico no es correcto';
        } else if (err.message === 'There is no user record corresponding to this identifier. The user may have been deleted.') {
          this.errorMessage = 'No hay ningún registro de usuario que corresponda a este identificador.';
        } else {
